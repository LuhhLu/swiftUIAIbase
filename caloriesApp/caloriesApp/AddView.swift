        ...
        VStack{
            ...
            VStack(spacing: 25){
                ...
                Button(action: {
                    switch itemselected {
                    case .Breakfast:
                        vm.addBreakfast(icon: icon, name: name, ingredients: titel, fat: CGFloat(Int(fat) ?? 0 ), protein: CGFloat(Int(protein) ?? 0), cards:CGFloat(Int(cards) ?? 0) )
                        envi.wrappedValue.dismiss()
                    case .Lunch:
                        vm.addLunch(icon: icon, name: name, ingredients: titel, fat: CGFloat(Int(fat) ?? 0 ), protein: CGFloat(Int(protein) ?? 0), cards:CGFloat(Int(cards) ?? 0) )
                        envi.wrappedValue.dismiss()
                    case .Dinner:
                        print("Dinner")
                    case .Snacks:
