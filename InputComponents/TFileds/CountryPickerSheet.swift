...
struct PhoneNumberTextField: View {
        ...
        VStack{
            HStack{
                ...
                .onChange(of: phoneNumber) {old, newValue in
                    ...
                    matchCountryForDialingCode()
                   
                }
                .onChange(of: selectedCountry) { old,newCountry in
                    phoneNumber = newCountry.dialingCode
                }
                .onAppear(){
    ...
    private func matchCountryForDialingCode() {
        guard phoneNumber.count >= 2 else { return }

        // Normalize the input to handle both "+81" and "0081"
